...
"""
    ...
    def WriteSources(
        ...
        for source_path in compilable:
            ...
            print(f'quoted source_path: {quoted_obj_path}')
    ...
    def ComputeOutputBasename(self, spec):
        ...
        print(f'spec-:{spec}')
        target_prefix = target_prefix if (target_prefix == 'lib' and target_ext == '.dll' and self.flavor == 'win' and self.type == 'shared_library') else spec.get("product_prefix", target_prefix)
    ...
    def ComputeOutput(self, spec):
        ...
        print(f'path:{path} Output: {os.path.join(path, self.ComputeOutputBasename(spec))}')
